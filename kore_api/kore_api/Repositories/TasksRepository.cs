...
namespace kore_api.Repositories
{
    public class TasksRepository : ITasksRepository
    {
        ...
        {
            var query = from x in _context.Task
                        join y in _context.Taskmembership on x.Id equals y.TaskId into xy
                        from subtask in xy.DefaultIfEmpty()
                        ...
                        select new TaskVM
                        {
                            ...
                            UserId = xy == null ? 0 : (subtask.UserId ?? 0),
                            OrgId = x.OrgId,
